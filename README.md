...
- `index.html`: アプリ本体です。HTML、CSS、JavaScript をこの1ファイル内にまとめています。献立CSV/OCR結果の解析、園児数CSVの反映、発注ルールCSVまたはコード内標準ルールによる発注単位変換、発注書xlsxの作成までブラウザ内で実行します。
...
6. 手直し後に **発注書Excel（.xlsx）をダウンロード** を押してください。
