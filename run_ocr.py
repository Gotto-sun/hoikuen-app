...
EXCLUDED_INGREDIENT_PATTERN = re.compile(r"スチコン|オーブン|コンビモード|レンジ|機器|器具|コンソメ|ョヨンツメ|ヨ肥外|米$|^米$|精白米|白米|ごはん|御飯|だし|出汁|だし汁|煮干しだし|かつおだし|昆布だし|水$|調味料|調味料全般|食塩|塩$|砂糖|しょうゆ$|醤油$|みそ|味噌|酢$|油$|サラダ油|ごま油|酒$|みりん|こしょう|胡椒|ソース|ケチャップ|マヨネーズ|中華だし|カレー粉|片栗粉|片栗|片困粉|用本明|有本塊")
...
CANONICAL_INGREDIENT_PATTERNS = [
    ...
    ("鶏もも(皮なし)", re.compile(r"鶏\s*(?:もも|モモ)\s*(?:肉)?|鶏肉|とり\s*もも\s*肉")),
    ...
    ("クリームコーン缶", re.compile(r"クリーム\s*コーン\s*(?:缶|かん|館)?|コーン缶")),
