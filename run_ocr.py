...
CANONICAL_INGREDIENT_PATTERNS = [
    ...
    ("きゅうり", re.compile(r"きゅうり|きゆうり|きめゅうり|さきゅうり|きゅうの|胡瓜")),
    ...
    ("コーン缶", re.compile(r"コーン缶|コーン向|とうもろこし缶|トウモロコシ缶")),
