...
EXCLUDED_INGREDIENTS = {"しょうゆせんべい", "片栗粉", "きな粉"}
SENTENCE_MARKERS = ["。", "、", "です", "ます", "してください", "ため", "こと", "もの", "たら", "なら"]
NOISE_KANA = {"を", "ゑ", "ゐ"}
FORCED_INGREDIENT_CORRECTIONS = {
    "しょうゆせんべい": ("しょうゆせんべい", "醤油せんべい", "しょうゆせんし", "せんい"),
    "鶏もも(皮なし)": ("鶏もも(皮なし)", "鶏もも肉", "鶏もも肉(皮ない)", "鶏もも肉皮ない", "鶏モモ", "鶏モモ肉", "鶏肉", "とりもも肉"),
    "はるさめ": ("はるさめ", "春雨"),
    "ハム": ("ハム", "ロースハム"),
    "ねぎ": ("ねぎ", "ネギ", "葱"),
    "コーン缶": ("コーン缶", "コーン向", "コーン", "とうもろこし缶", "トウモロコシ缶"),
    ...
    "たまねぎ": ("たまねぎ", "玉ねぎ", "玉葱", "タマネギ", "玉ネギ", "たまねを", "たまねきぎ", "療半と"),
    "もやし": ("もやし", "もや", "よやし"),
    "きゅうり": ("きゅうり", "きゆうり", "きめゅうり", "さきゅうり", "胡瓜", "きゅうの"),
    ...
    "たけのこ": ("たけのこ", "筍", "竹の子"),
    "かまぼこ": ("かまぼこ", "蒲鉾"),
    "ブロッコリー": ("ブロッコリー", "ブロコリー", "ブロッコリ", "プロッコリー", "ブロツコリー", "ブロシンコリ", "ブロシッコリー"),
    "クリームコーン缶": ("クリームコーン缶", "クリームコーン", "クリームコーンかん", "クリームコーン館"),
    "豆乳": ("豆乳", "とうにゅう", "トウニュウ", "豆孔", "豆礼"),
    "オレンジ濃縮果汁": ("オレンジ濃縮果汁", "オレンジ果汁", "オレンジ濃縮", "濃縮オレンジ果汁", "オレンジのうしゅく果汁"),
    "粉かんてん": ("粉かんてん", "粉寒天", "かんてん", "寒天", "粉かんでん"),
    "みかん缶": ("みかん缶", "みかん", "みかんかん", "みかん和缶", "みかん人缶", "ミカン缶", "蜜柑缶"),
