...
def ensure_food_master(path: Path) -> None:
    ...
    path.write_text(
        ...
        'にんじん,人参;ニンジン;人じん;にんん;にんヒじん;0 80 66 9;080669,1.10,g,青果業者' "\n"
        ...
        '缶詰,桃缶;パイン缶,1.00,缶,食品業者' "\n"
        '鶏モモ肉,鶏モモ肉,1.05,kg,精肉業者' "\n"
        '鶏もも(皮なし),鶏モモ肉(皮なし);鶏もも肉;鶏モモ;鶏肉;とりもも肉,1.05,kg,精肉業者' "\n"
        'はるさめ,春雨,1.00,袋,食品業者' "\n"
        ...
        'なめこ,ナメコ,1.00,袋,青果業者' "\n"
        'クリームコーン缶,クリームコーン;クリームコーンかん;クリームコーン館,1.00,缶,食品業者' "\n"
