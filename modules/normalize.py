...
def ensure_food_master(path: Path) -> None:
    ...
    path.write_text(
        ...
        'たまねぎ,玉ねぎ;玉葱;玉ねき;たまねきぎ;タマネギ;玉ネギ;たまねを;療半と,1.08,kg,青果業者' "\n"
        ...
        'きゅうり,きゆうり;きめゅうり;さきゅうり;胡瓜;きゅうの,1.10,kg,青果業者' "\n"
        ...
        '缶詰,桃缶,1.00,缶,食品業者' "\n"
        '鶏もも(皮なし),鶏もも肉;鶏もも肉(皮ない);鶏もも肉皮ない;鶏モモ;鶏モモ肉;鶏肉;とりもも肉,1.05,kg,精肉業者' "\n"
        'はるさめ,春雨,1.00,袋,食品業者' "\n"
        'ハム,ロースハム,1.00,パック,食品業者' "\n"
        'ねぎ,ネギ;葱,1.10,kg,青果業者' "\n"
        'コーン缶,コーン;コーン向;とうもろこし缶;トウモロコシ缶,1.00,缶,食品業者' "\n"
        ...
        'かまぼこ,蒲鉾,1.00,本,食品業者' "\n"
        'ブロッコリー,ブロツコリー;ブロコリー;ブロッコリ;プロッコリー;ブロシンコリ;ブロシッコリー,1.10,kg,青果業者' "\n"
        'チーズ,スライスチーズ;粉チーズ,1.00,個,乳製品業者' "\n"
        '調整豆乳,調製豆乳,1.00,L,食品業者' "\n"
