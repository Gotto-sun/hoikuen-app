...
def ensure_food_master(path: Path) -> None:
    ...
    path.write_text(
        ...
        "ブロッコリー,ブロコリー;ブロッコリ;プロッコリー;ブロツコリー,1.10,kg,青果業者\n"
        "クリームコーン缶,クリームコーン;コーン缶,1.00,缶,食品業者\n"
        "豆乳,とうにゅう;トウニュウ,1.00,L,食品業者\n"
        "オレンジ濃縮果汁,オレンジ果汁;オレンジ濃縮,1.00,L,食品業者\n"
        "粉かんてん,粉寒天;かんてん;寒天,1.00,袋,食品業者\n"
        "みかん缶,みかん;ミカン缶;蜜柑缶,1.00,缶,食品業者\n"
        "豚肉(もも),豚もも肉;豚肉もも;豚肉（もも）,1.05,kg,精肉業者\n"
        "SBカレーフレーク,S&Bカレーフレーク;カレーフレーク,1.00,袋,食品業者\n"
        "だいこん,大根;ダイコン,1.15,kg,青果業者\n"
        "ツナ油漬,ツナ;ツナ缶;ツナ油漬け,1.00,缶,食品業者\n"
        "パイン缶,パイン;パイナップル缶;パイナップル,1.00,缶,食品業者\n"
        "スパゲティ,スパゲッティ;スパゲテイ;パスタ,1.00,kg,食品業者\n"
        "パイシート(冷凍),パイシート;冷凍パイシート;パイシート（冷凍）,1.00,枚,食品業者\n",
        '正式名称,別名,ロス率,発注単位,仕入先' "\n"
        ...
        '豚肉(もも),豚もも肉;豚肉もも;豚モモ肉;豚肉,1.05,kg,精肉業者' "\n"
        'たけのこ,筍;竹の子,1.00,kg,青果業者' "\n"
        'かまぼこ,蒲鉾,1.00,本,食品業者' "\n"
        'ブロッコリー,ブロツコリー,1.10,kg,青果業者' "\n"
